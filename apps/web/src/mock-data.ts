...
export const mockBlocks: DryvreBlock[] = [
  ...
  { id: 'record-story', parentId: 'launch-checklist', title: 'Record the three-minute product story', bodyMd: 'Waiting for final approval on the public demo URL.', icon: '□', status: 'blocked', author: 'Mina Kim', updatedLabel: '14 minutes ago', canonical: true },
